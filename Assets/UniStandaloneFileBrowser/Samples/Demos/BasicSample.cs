...
public class BasicSample : MonoBehaviour
{
    ...
    async void OnGUI()
    {
        ...
        {
            var result = await StandaloneFileBrowser.OpenFilePanelAsync("Open File", "", "", false);
            WriteResult(result);
        }
        ...
        {
            var result = await StandaloneFileBrowser.OpenFolderPanelAsync("Select Folder", "", true);
            WriteResult(result);
        }
        ...
        {
            var result = await StandaloneFileBrowser.SaveFilePanelAsync("Save File", "", "", "");
            WriteResult(result);
        }
